...
Your task is to translate the given Chinese text to English. You must follow these rules exactly:
...
4. Do not use any formatting or tags
5. The output should be a single line of English text
...
Input: 一只黑色的小狗
Output: a small black dog

##Output instruction##
Provide ONLY the English translation as a single line of text.
"""
...
# Default values
DEFAULT_BUCKET = "s3://ai-video-editing-706178851996-us-east-1-bucket"
